    ...
    <div className="border border-[#D0D5DD] rounded-xl p-6 bg-white w-full">
      ...
      <form onSubmit={handleSubmit(handleFormSubmit)}>
        <div className="grid md:grid-cols-2 grid-cols-1 gap-6">
          ...
          {initialData ?  
            <div className="form-group">
            <label htmlFor="#">Quick Action</label>
              <div className="all_act_Btns">
                <button
                  type="button"
                  className="inline-flex items-center gap-2 px-4 py-3 border border-[#E4E7EC] rounded-lg text-sm font-medium text-[#fff] bg-[#7F1919]" >
                  End Early
                </button>
                <button
                  type="button"
                  className="inline-flex items-center gap-2 px-4 py-3 border border-[#E4E7EC] rounded-lg text-sm font-medium text-[#fff] bg-[#FF3B30]" >
                  Refund
                </button>
                <button
                  type="button"
                  className="inline-flex items-center gap-2 px-4 py-3 border border-[#E4E7EC] rounded-lg text-sm font-medium text-[#505050] bg-[#72EA5A]" >
                  Extend
                </button>
              </div>
            </div>
